<template>
  <div>
    <div>
      <div
        class="h-hit min-h-screen overflow-scroll w-screen flex flex-col justify-center max-w-6xl py-10"
        v-if="!logged_in"
      >
        <div
          class="mx-5 px-5 md:mx-10 md:px-10 lg:mx-20 lg:px-20 flex flex-col"
        >
          ...
          <div class="mt-1 md:mt-3">
            ...
            <div class="flex w-fit w-full flex-col md:flex-row flex-nowrap">
              <div class="rounded-md shadow flex-shrink-0">
                <a
                  href="#"
        ...
        <div
          class="relative mx-10 md:mx-20 lg:mx-40 mt-5 md:mt-10 lg:mt-20 px-5 py-5 rounded-md w-fit flex flex-col bg-gray-100"
        >
          <span
      ...
      <transition name="slide-left">
        <div
          class="h-hit min-h-screen overflow-scroll w-screen flex flex-col justify-center py-10"
          v-if="logged_in"
        >
          <div
            class="mx-5 px-5 md:mx-10 md:px-10 lg:mx-20 lg:px-20 flex flex-col justify-center"
          >
            <span
              class="text-5xl md:text-6xl font-extrabold text-gradient text-center"
              >Welcome back, {{ $nam.user.name }}</span
            >
            <div class="mt-5 flex flex-row justify-center">
              ...
              <span
                class="text-4xl md:text-5xl font-extrabold text-gray-700 text-center"
              >
...
export default {
  ...
  methods: {
    ...
    async checkLoginStatus() {
      this.logged_in = await this.$nam.auth.checkLoginStatus();
      if (this.logged_in) {
