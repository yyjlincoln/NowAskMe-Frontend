<template>
  <div>
    <span
      class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gradient py-1"
      >Privacy Policy</span
    >
    <div class="mt-7">
      ...
      <p
        class="text-2xl md:text-3xl lg:text-4xl font-extrabold text-gradient py-1"
      >
        Interpretation and Definitions
      </p>
      <p class="text-xl md:text-2xl lg:text-3xl font-extrabold text-black py-1">
        Interpretation
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Nowask.me.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Nowask.me, accessible from
            <a href="nowask.me" rel="external nofollow noopener" target="_blank"
              >nowask.me</a
            >
          </p>
        </li>
      ...
      <p class="text-lg md:text-xl lg:text-2xl font-extrabold text-black py-1">
        Personal Data
      </p>
      <p>
      ...
      <ul>
        <li>By email: privacy@mcsrv.icu</li>
      </ul>
    </div>
  </div>
</template>
